...
В данной лабораторной работе синхронизация осуществляется с помощью объектов ядра мьютексов, а не критических секций. Ведь синхронизацию нужно выполнять между процессами, а критические секции синхронизируют потоки в рамках одного процесса. Чего не скажешь о мьютесах и семофорах.
...
Протоколы программ, по которым строились графики, и логи доступны:
